...
const module46DemoDialogueSequence = [
    {
        side: 'left',
        label: '当事人',
        text: '唉，我完了。今天汇报的时候竟然说错了一个关键数据，虽然马上纠正了，但所有人都听到了。我搞砸了这么重要的场合，领导和同事肯定都在心里给我打叉，觉得我能力不行。我的职业形象全毁了。',
        audioPath: encodeURI('audio/module46/4-6当事人1-yx.mp3')
    },
    {
        side: 'right',
        label: '支持者',
        text: '我听到了，你现在被一个“我搞砸了，职业形象全毁了”的想法紧紧抓住，这让你感到非常焦虑和挫败。（<span class="annotation">识别与共情</span>）',
        audioPath: encodeURI('audio/module46/4-6支持者1-xh.mp3')
    },
    {
        side: 'left',
        label: '当事人',
        text: '不止是想法，这就是事实啊！那么多人看着呢。',
        audioPath: encodeURI('audio/module46/4-6当事人2-yx.mp3')
    },
    {
        side: 'right',
        label: '支持者',
        text: '我理解那感觉非常真实。我们可以试着先把这个想法“放”到眼前看看吗？比如，给它贴个标签：这是一个关于“职业形象彻底崩溃”的灾难化预测。（<span class="annotation">贴标签</span>）',
    ...
    },
    {
        side: 'right',
        label: '支持者',
        text: '意思是，这个想法把一次口误的后果，想象成了无法挽回的终极灾难。它是一个“预测”，而不是已经发生的“事实”。事实是：一，你完成了一次季度汇报；二，过程中出现了一个口误，并已纠正。而“形象全毁、能力被否定”的想法是你对未来的悲观推测。（<span class="annotation">区分想法与事实</span>）',
    ...
    },
    {
        side: 'right',
        label: '支持者',
        text: '有可能，但这仍然是一种“他们可能会对我有看法”的想法或担心。当我们把它贴上“这是猜测他人想法”的标签时，我们就可以意识到，这和我们“知道”他们怎么想是两回事。把想法当作事实，会让我们陷入更深的焦虑。（<span class="annotation">巩固解离，将想法客观化</span>）',
        audioPath: encodeURI('audio/module46/4-6支持者4-xh.mp3')
    },
    {
        side: 'left',
        label: '当事人',
        text: '……你这么一说，好像是的。我被那个“我完了”的想法带着跑了，感觉天都塌了。',
        audioPath: encodeURI('audio/module46/4-6当事人5-yx.mp3')
    },
    {
        side: 'right',
        label: '支持者',
        text: '是的，想法有时候就像一部逼真的恐怖片，让我们身临其境。但我们其实只是正在看一部叫《我搞砸了》的电影，而不是真的生活在那个灾难场景里。当我们能看清这只是脑海中的一部电影，压力感就会开始松动，我们才能腾出空间去想：那么，基于目前的事实，我现在可以做哪一件小事？（<span class="annotation">引入行动视角</span>）',
