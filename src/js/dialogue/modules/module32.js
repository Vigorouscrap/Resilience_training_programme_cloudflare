...
const module32DefinitionCardHtml = `
    ...
    <ol style="margin: 0; padding-left: 2.3rem;">
        <li>强迫自己只关注积极想法，如：“我必须乐观”“不能有负面情绪”。</li>
        <li>压抑或否认真实的担忧、失落、焦虑等情绪，如：“我不该这么想”。</li>
        <li>用积极口号覆盖真实感受，而不是真正处理情绪。</li>
    </ol>
`;
...
const module32QuestionResponses = [
    {
        ...
        '过度积极反刍': '我理解你会这么想，有时候反复思考和确认信息确实容易让人感觉有些过度。不过在这个情境下，“努力了解项目相关信息”更多是为了解决问题而主动收集资料、理清情况，这其实属于积极应对的方式哦。'
    },
    {
        '积极应对': '我理解你的选择，“强迫自己只想好结果”听起来确实像是在努力保持积极。但实际上，这种反复强迫自己往好处想、不允许有丝毫怀疑或焦虑的硬性积极，其实容易让人忽视真实情绪，属于过度积极反刍哦。',
        '过度积极反刍': '正确，这是在用强制积极来回避真实的担心情绪。'
    },
    {
        '积极应对': '我明白你的想法，压抑情绪有时看起来像是管理情绪的一种方式。但实际上，刻意压制失落、悲伤等真实感受，并不是真正面对和解决问题，反而容易让情绪积压。这种做法属于过度积极反刍。',
        '过度积极反刍': '是的，压抑真实情绪，告诉自己不该有这种想法，是典型的过度积极反刍。'
    }
];

const module32ObservationCardHtml = `
    <p class="scene-title"><strong>【观察】</strong></p>
    <p>我现在感到______（情绪1），因为______（原因）；</p>
    <p>同时我也感到______（情绪2），因为______（原因）；</p>
    <p>我的身体感觉是______（部位+感受）。</p>
    <p><i><u>参考陈述</u></i>：“我现在感到担心，担心完不成项目，同时有些沮丧，因为就算完成了也不能升职，胸口闷闷的。”</p>
`;

const module32AllowanceCardHtml = `
    <p class="scene-title"><strong>【允许】</strong></p>
    <p>这些情绪都是正常的，因为______（正常化原因）；</p>
    <p>我不需要______（停止的自我批判）；</p>
    <p>我可以______（允许的表达）。</p>
    <p><i><u>正常化原因</u></i>：“面对重要任务感到担心是人之常情”</p>
    <p><i><u>停止的自我批判</u></i>：不需要“强迫自己必须乐观”、不用批判自己“不该有这种情绪”</p>
    <p><i><u>允许的表达</u></i>：“和这些情绪共处一会儿”、“承认我现在确实有这些感受”</p>
`;

const module32ExpansionCardHtml = `
    <p class="scene-title"><strong>【扩展】</strong></p>
    <p>除了这些情绪，我还能注意到：</p>
    <p>环境中的______（感官观察1）；</p>
    <p>身体其他的______（中性身体感受2）；</p>
    <p>此刻还存在的______（其他存在状态）。</p>
    <p><i><u>参考陈述</u></i>：“除了担心和失落，我还能注意到窗外的光线变化，能感觉到脚底接触地面的踏实感，能意识到呼吸的进出。”</p>
`;

const module32ActionCardHtml = `
    <p class="scene-title"><strong>【行动】</strong></p>
    <p>基于观察和接纳，现在可以采取的小行动来缓解矛盾心理：</p>
    <p>我可以做______（具体行动1）来照顾当下的情绪；</p>
    <p>我也可以做______（具体行动2）来推进实际事务；</p>
    <p>我选择不做______（避免的强迫行为）。</p>
    <p><i><u>情绪照顾行动</u></i>：给信任的人发条消息、深呼吸5次、短暂休息10分钟</p>
    <p><i><u>实际推进行动</u></i>：列出项目风险清单、与领导沟通、制定阶段性计划</p>
    <p><i><u>避免的强迫行为</u></i>：避免强迫自己立刻变积极、不压抑所有担忧、不假装一切完美</p>
`;
...
export const module32Handlers = {
    onContinue_Module32() {
        if (this.step === 0) {
            ...
            appendAiMessage(this.chatMessages, '今天我们重点学习了过度积极反刍，即那些强迫必须积极反而压抑真实情绪的心理模式，并进一步将接纳技术扩展应用到这些场景。', true);
            this.step = 23;
