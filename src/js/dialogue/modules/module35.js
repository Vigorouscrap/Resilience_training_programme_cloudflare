...
const module35ExampleOneCardHtml = `
    <p><strong>示例一：体重焦虑</strong></p>
    <p>触发场景：忍不住过度关注体重，每天称3次，数字没下降就感到一切努力都白费了。</p>
    <p>接纳行动：未来几天，当我又想频繁称体重时，我就先深呼吸10秒，告诉自己“人体体重有波动很正常”，然后活动下四肢，接纳当下的体重状态，继续自己的一天。</p>
`;

const module35ExampleTwoCardHtml = `
    <p><strong>示例二：选择困难</strong></p>
    <p>触发场景：要买一个物品，担心买到的不够好，反复对比十几个品牌，越选越慌。</p>
    <p>接纳行动：未来几天选购物品时，若开始反复纠结，就停下来列出2个核心需求（如“耐用、美观”），选择出第一个符合的物品即可，接纳“没有完美的用品”，告诉自己这个选择足以满足我的核心需求。</p>
`;

const module35ExampleThreeCardHtml = `
    <p><strong>示例三：拖延</strong></p>
    <p>触发场景：面对一份又多又难的实验报告作业，感觉完全不知道从哪里下手，脑子里一片空白，越拖延越焦虑，觉得自己肯定做不完也做不好。</p>
    <p>接纳行动：未来几天，当我又在面对复杂任务感到瘫痪时，我会先立即放下手机，离开让我分心的环境，坐回书桌前。然后告诉自己这个任务看起来确实很多很难，感到无从下手和焦虑是完全正常的。我不需要一次解决所有问题。先从最小的事做起，比如打开文档，写下作业的标题；或者，把作业要求读一遍，用荧光笔划出3个关键词。允许自己从这最小的、不完美的一步开始。</p>
`;

const module35InspirationCardHtml = `
    <p>健康/外貌：对运动数据、饮食控制过度关注。</p>
    <p>人际关系：过度揣测他人的看法或某次对话。</p>
    <p>工作学习：因追求完美而拖延，或过度担忧结果。</p>
    <p>日常选择：在小决定上反复纠结，消耗大量精力。</p>
    <p>逆境创伤：对于发生过的事情无法释怀，反复想起</p>
    <p>其他：……</p>
`;
