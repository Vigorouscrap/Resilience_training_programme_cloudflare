...
const module22Cases = {
    a: {
        ...
        repeatStory: '<p>张天是一名大四学生，面对“毕业即失业”的说法和身边同学陆续拿到签约工作的状况，他感到很有压力。家人也时时催促张天找工作的进度，并总说必须要找到一份高薪体面的工作，否则就代表这大学四年根本就没有好好学习。张天越来越焦虑，慢慢地为了逃避这种焦虑和可能的失败，<strong>他开始没日没夜地打游戏，拒绝参加任何招聘会，甚至不敢点开学校的就业指导邮件。</strong>他表面上对朋友说“不急，慢慢找”，但内心的自我怀疑和恐慌却与日俱增，整个人都处在一种“瘫痪”的状态。</p>',
        ...
        impactCard: '<p><strong>1 身心健康</strong>：焦虑不减反增，作息紊乱</p><p><strong>2 自我认知</strong>：自我怀疑加深，行动力瘫痪</p><p><strong>3 人际关系</strong>：与家人沟通更困难，回避朋友</p><p><strong>4 现实发展</strong>：错过招聘机会，毕业压力更大</p><p><strong>5 情绪模式</strong>：更习惯用逃避应对压力</p>',
    ...
    b: {
        ...
        repeatStory: '<p>晓琳和男友近几个月来争吵不断，关系变得很紧张。她感到非常受伤和孤独，内心渴望沟通和亲近。<strong>但每当她想开口谈谈时，心里就会冒出一个声音：“说了也没用，只会又吵起来，算了吧”。于是，她选择了沉默，把所有的委屈都压在心里，用加班和追剧填满所有时间，避免与伴侣独处。</strong>她以为自己“不计较”就能让事情过去，却发现两人之间的隔阂像一堵墙，越来越厚。</p>',
        ...
        impactCard: '<p><strong>1 身心健康</strong>：疲劳累积，难以真正放松</p><p><strong>2 自我认知</strong>：更不相信沟通有用</p><p><strong>3 亲密关系</strong>：与伴侣的互动频率与质量持续下降</p><p><strong>4 行为模式</strong>：更习惯用忙碌替代情绪表达</p><p><strong>5 情绪变化</strong>：孤独感未减轻，对关系的无力感增强</p>',
    ...
    c: {
        ...
        repeatStory: '<p>32岁的嘉怡是团队负责人，最近工作压力很大，因为她很担心无法按时完成她手上负责的所有项目。但身边人都说"你能力这么强，肯定没问题"。<strong>敏敏强撑着，不再表达自己的压力，但工作效率明显下降，对原本热爱的工作也失去了热情，睡眠也变差了。</strong></p>',
        ...
        impactCard: '<p><strong>1 身心健康</strong>：睡眠持续变差，身体进入慢性疲劳状态</p><p><strong>2 工作表现</strong>：效率进一步下降，错误率可能增加</p><p><strong>3 自我认知</strong>：越来越不相信可以示弱，把疲惫等同于失败</p><p><strong>4 情绪模式</strong>：对原本热爱的工作产生疏离感，热情难以恢复</p><p><strong>5 人际关系</strong>：身边人继续认为她没问题，真实支持越来越少</p><p><strong>6 现实风险</strong>：项目若真的延期，她会更强烈地自责，而不是归因于资源或压力</p>',
...
export const module22Handlers = {
    onContinue_Module22() {
        if (this.step === 0) {
            ...
            appendAiMessage(this.chatMessages, '其实这三个故事，都在讲述同一种心理模式：当我们感到焦虑、受伤或压力时，有时会选择推开感受、转移注意或假装没事，这在心理学上有一个名字，叫做<strong>经验性回避</strong>。', true);
            this.step = 11;
