...
const module52TechniqueCards = [
    {
        html: `
            ...
            <div class="module5-media-body">
                <p>操作方法：想象将想法写在气球上，双手握住气球，慢慢松开手，看着气球带着想法飘向远方，逐渐消失。</p>
                <p>适用场景：消极思维（如“体检指标波动，认为身体有问题”）、过度积极思维（如“我必须做好这个汇报，否则职业发展会受到影响”）。</p>
                <p>注意事项：想象过程中保持平静，若情绪波动较大，可暂停后再尝试。</p>
            </div>
        `,
        mediaHtml: `
            <p class="module5-media-title">【方法一：气球放飞法】演示</p>
            <div class="module5-media-body">
                <p><strong>AI音频：</strong>针对“体检指标波动，我的身体是不是有问题了”的想法，现在把“体检指标波动，我的身体是不是有问题了”写在气球上，握住气球，感受想法的重量，慢慢松手，看着气球飘走，想法也跟着离开。</p>
        ...
        `,
        speechText: '针对“体检指标波动，我的身体是不是有问题了”的想法，现在把“体检指标波动，我的身体是不是有问题了”写在气球上，握住气球，感受想法的重量，慢慢松手，看着气球飘走，想法也跟着离开。',
        onInit(card) {
    ...
    {
        html: `
            <p class="module5-media-title">【角色转换法】</p>
            <div class="module5-media-body">
                <p>操作方法：把自己的想法想象成朋友的想法，以朋友的身份对“自己”说安慰的话。</p>
                <p>适用场景：难以跳出自身思维时，尤其适合过度积极反刍（如“我要做到让所有人满意”）。</p>
                <p>注意事项：回应时需真诚，避免敷衍，真正站在客观角度看待想法。</p>
            </div>
        `,
        mediaHtml: `
            <p class="module5-media-title">【角色转换法】演示</p>
            <div class="module5-media-body">
                <p><strong>AI音频：</strong>针对“我要做到让所有人满意”的想法，想象成这是朋友的一个想法，如果朋友这么说，我会告诉她“你不用满足所有人的期待，做真实的自己就够了”或者“偶尔没做到没关系，你已经很用心了”。</p>
            </div>
        `,
    ...
    {
        html: `
            <p class="module5-media-title">【时间线法】</p>
            <div class="module5-media-body">
                <p>操作方法：先回想一个过去曾困扰过你的想法，如今再看，它对你的影响已经微乎其微了。现在，试着把自己放在长长的时间轴上，去观察眼前这个正在困扰你的想法，再望向一年后的自己，你会发现，这个想法对未来的影响同样很小。慢慢地，试着放下对它的执着。</p>
                <p>适用场景：被想法困扰较久时，如长期担心“因为我上次那个失误，永远也翻不了身了”。</p>
                <p>注意事项：时间线想象需清晰，若难以集中注意力，可先深呼吸再尝试。</p>
            </div>
        `,
        mediaHtml: `
            <p class="module5-media-title">【时间线法】演示</p>
            <div class="module5-media-body">
                <p><strong>AI音频：</strong>针对“因为那个失误，我永远翻不了身” 的想法：站在时间轴上，注意到现在的“永远翻不了身”是一个念头，看向一年后，生活还在继续，这个担心已经过去了，只是漫长人生线上的一个小点，现在不用被它困住。</p>
            </div>
        `,
...
export const module52Handlers = {
    onContinue_Module52() {
        if (this.step === 0) {
            appendAiMessage(this.chatMessages, '上周我们学习了认知解离，认识到将想法与事实区分开的重要性。然而在将认知解离应用到实际情境的过程中，你有可能已经发现尽管努力将想法与事实分离开来，但想法有的时候还总是萦绕在脑边不肯走。', true);
            this.step = 1;
        } else if (this.step === 1) {
            ...
            startCardCountdown(this.chatMessages, 30, '可继续', () => {
            ...
            appendAiMessage(this.chatMessages, '请选择你想进行针对练习的想法（1或2）。', false);
            ...
            const text = `（AI朗读）：首先是气球法。好，请闭上眼睛。想象“${practiceThought}”这句话写在一个气球上…感受一下握着它的感觉…现在，慢慢地、有意识地松开你的手指…看着它飘走…`;
            ...
            const practiceThought = this.escapeHtml(getModule52PracticeSpeechText(this.module52State.selectedThought));
            const text = `（AI朗读）：假设你最好的朋友对你说：“${practiceThought}”你会怎么安慰他？请在心里或轻声说出你的回答。`;
            appendAiMessage(this.chatMessages, text, false);
            speakText(this.chatMessages, text, { rate: 0.9, fallbackMs: 30000 });
            appendContinueButton(this.chatMessages, 30);
            this.step = 12;
            ...
            const text = `（AI朗读）：现在，想象自己站在时间轴上，感受一下这个“${selectedThought}”的想法。然后，向前走到“一年后”的位置，回头看现在的这个想法——一年后的你，会觉得这个要求还像现在这么绝对和沉重吗？试着感受一下那种时间带来的距离感。`;
            appendAiMessage(this.chatMessages, text, false);
            speakText(this.chatMessages, text, { rate: 0.9, fallbackMs: 30000 });
            appendContinueButton(this.chatMessages, 30);
            this.step = 14;
