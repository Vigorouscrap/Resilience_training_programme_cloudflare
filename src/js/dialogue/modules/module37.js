...
export const module37Handlers = {
    onContinue_Module37() {
        if (this.step === 0) {
            ...
            appendAiMessage(this.chatMessages, '我们前两天还进行了自我承诺行动，每当你执行了你的接纳行动后，可以随时打开链接记录（https://v.wjx.cn/vm/YDIVxE6.aspx#）。这种记录方式还会再持续几天，相信通过一次一次的记录，我们能够更自如地应对情绪与压力。', true);
            this.step = 19;
