...
const module33GoalsCardHtml = `
    <p>第一，体验视角的转换。我们将同时从“陷入反刍的自己”和“善于接纳的引导者”这两个角度来体验。这能帮助我们更深刻地理解：当焦虑升起时，内心在发生什么；以及一个充满接纳的回应，是如何一步步创造改变的。</p>
    <p>第二，拓宽识别的雷达。我们将尝试把“过度积极反刍”的识别能力，应用到更广泛、更个人化的生活场景中。你会看到，它可能藏在“我必须完美”的工作计划里，也可能躲在“万一他不喜欢我”的人际担忧中。识别，就是改变的第一步。</p>
`;

const module33ScenesCardHtml = `
    <p><strong>【场景1：饮食控制焦虑】</strong></p>
    <p>过度积极反刍者：我今天多吃了一块蛋糕，网上说这样明天会重很多！我怎么这么缺乏意志力？连这点小事都做不好，减肥计划全都毁了！</p>
    <p>（核心：因饮食超过计划产生自我批判，“陷入做得不够好→影响减肥计划”的反刍。）</p>
...
const module33DemoCardHtml = `
    ...
    <p>（停顿2秒）</p>
    <p>接纳者AI（温和语气）：“（观察）听起来你特别在意体重的变化，因为这一块蛋糕，现在既担心又有点自责，对吗？”）（——这里先点出反刍者的“在意”和“自责”，帮其看见自己没说出来的情绪，而不是直接否定她的担心。）</p>
    <p>反刍者AI：“对，就是觉得自己太没用了，这点要求都达不到。”</p>
    <p>接纳者AI：“（允许）其实真的不用这么怪自己。饮食控制本来就不容易，偶尔超出计划，很多人都会这样。有这些情绪很正常，它不是你的错。”（——这里强调“正常”和“不是错”，是让反刍者不用对抗自己的负面感受，减少自我批判。）</p>
    <p>反刍者AI：“可我还是担心体重减不下来。”</p>
    <p>接纳者AI：“（扩展）我理解这份担心。那除了这一块蛋糕，你这周有没有坚持完成了计划内的运动？或者有没有哪一餐是成功按照计划健康饮食的？”（——这里引导反刍者想其他积极的事，是帮反刍者从“没做好”的反刍里抽离出来，不让注意力只盯着负面点。）</p>
    <p>反刍者AI：“嗯…昨天前天都去跑步了，午餐也吃得挺健康的。”</p>
    <p>接纳者AI：“（引导行动）你看，其实你做得挺好的。如果现在还是有点慌，要不要先喝口水，或者把今天的情况简单记一下？我们可以想一个小调整，而不是否定全部努力。”（——最后引导具体行动，是帮反刍者从“焦虑”转向“能做的事”，减少反刍带来的无力感。）</p>
`;
