...
const module33Rounds = [
    {
        ...
        responses: {
            'A. 你别想太多了，可能只是你自己太敏感了。': '这是一个常见的回应方式。不过，当一个人深陷反刍时，直接否定，可能会让ta觉得自己的感受不被接纳并增加压力。第一步的关键是先建立情感连接即选择B【听起来你很在意和这位同事的关系，同时也有点担心和困惑，对吗】，确认对方的感受是合理的。让我们继续看看下一步。',
            'B. 听起来你很在意和这位同事的关系，同时也有点担心和困惑，对吗？': '很好。你选择了观察情绪的回应。你准确地指出了对方“在意关系”和“担心困惑”的感受，这让对方感到自己的情绪被看见了，而不是被评判或忽视。这是建立信任对话的第一步。',
            'C. 那你打算怎么办？直接去问他吗？': '这是一个常见的回应方式。不过，当一个人深陷反刍时，急于解决问题，可能会让ta觉得自己的感受不被接纳并增加压力。第一步的关键是先建立情感连接即选择B【听起来你很在意和这位同事的关系，同时也有点担心和困惑，对吗】，确认对方的感受是合理的。让我们继续看看下一步。'
        }
    },
    {
        ...
        responses: {
            'A. 你真的不应该这样怀疑自己，要自信一点。': '这一回应隐含批评，可能会加剧反刍者的自责。因此，这一步我们应当引导对方将情绪体验正常化，允许情绪的存在，即采用选项B提供的回应【在不确定的情况下感到担心和反复思考，其实是很自然的事，很多人都这样。你不必为此责怪自己】。',
            'B. 在不确定的情况下感到担心和反复思考，其实是很自然的事，很多人都这样。你不必为此责怪自己。': '这是允许存在的正确回应。它将对方的体验“正常化”（“很多人都这样”），并直接解除了自我批判（“不必责怪自己”）。这能减少与情绪的对抗，为焦虑的情绪创造一个安全的降落场，而不是让它在空中继续盘旋。',
            'C. 别担心了，我帮你分析一下。': '这其实是在急于接管问题，可能削弱对方的自主感。因此，这一步我们应当引导对方将情绪体验正常化，允许情绪的存在，即采用选项B提供的回应【在不确定的情况下感到担心和反复思考，其实是很自然的事，很多人都这样。你不必为此责怪自己】。'
        }
    },
    {
        ...
        responses: {
            ...
            'B. 你必须找出原因，不然这个问题会一直困扰你。': '这一回应强化了反刍的紧迫性，可能加剧焦虑。因此，这一步我们应当引导反刍者将关注点从单一负面线索，扩展到更全面的人际体验，即选择A【除了担心这位同事的看法，最近和其他同事或朋友的相处中，有没有感觉比较愉快或顺利的时刻】。',
            'C. 那就列个清单，想想你所有可能做得不对的地方。': '这一回应看似要解决问题，实际上会引导至更深的细节反刍，是无效的“解决”尝试。因此，这一步我们应当引导反刍者将关注点从单一负面线索，扩展到更全面的人际体验，即选择A【除了担心这位同事的看法，最近和其他同事或朋友的相处中，有没有感觉比较愉快或顺利的时刻】。'
        }
    },
    {
        ...
        responses: {
            ...
            'B. 那你现在立刻去找他问清楚吧。': '这提议了一个可能超出对方当下准备度的重大行动。实际上，这一步提供的应当是立即可行的、与当下身体感受连接的、照顾性的行动，这个行动本身不是目的，而是为不安的情绪提供一个稳定、温和的锚点，因此应选择A【如果现在感觉不踏实，要不要先停下来，喝口水，感受一下双脚稳稳踩在地面的感觉】。',
            'C. 别想了，明天再说。': '这个回应回避了问题，未能提供建设性出口。实际上，这一步提供的应当是立即可行的、与当下身体感受连接的、照顾性的行动，这个行动本身不是目的，而是为不安的情绪提供一个稳定、温和的“锚点”，因此应选择A【如果现在感觉不踏实，要不要先停下来，喝口水，感受一下双脚稳稳踩在地面的感觉】。'
        }
    }
];
