...
const module54PositiveDemoAudioPath = encodeURI('audio/module54/5-4积极反刍思维举例练习.mp3');
const module54NegativeDemoAudioPath = encodeURI('audio/module54/5-4消极反刍思维举例练习.mp3');
const module54PositivePracticeAudioPath = encodeURI('audio/module54/5-4积极反刍思维深入练习.mp3');
const module54NegativePracticeAudioPath = encodeURI('audio/module54/5-4消极反刍思维深入练习.mp3');
    ...
    onContinue_Module54() {
        if (this.step === 0) {
            ...
            appendSpeechReplayCard(
                ...
                {
                    replayLabel: '再次播放',
                    audioPath: module54PositiveDemoAudioPath,
            ...
            appendSpeechReplayCard(
                ...
                {
                    replayLabel: '再次播放',
                    audioPath: module54NegativeDemoAudioPath,
                    audioMimeType: 'audio/mpeg',
                    disableSpeechFallback: true,
                    onEnded: () => {
                        appendContinueButton(this.chatMessages);
            ...
            appendSpeechReplayCard(
                ...
                {
                    replayLabel: '再次播放',
                    audioPath: module54PositivePracticeAudioPath,
                    audioMimeType: 'audio/mpeg',
                    disableSpeechFallback: true,
                    onEnded: () => {
                        appendContinueButton(this.chatMessages);
            ...
            appendSpeechReplayCard(
                ...
                {
                    replayLabel: '再次播放',
                    audioPath: module54NegativePracticeAudioPath,
                    audioMimeType: 'audio/mpeg',
                    disableSpeechFallback: true,
                    onEnded: () => {
                        appendContinueButton(this.chatMessages);
